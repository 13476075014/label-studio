  ...
  pages: {
    ...
    projects: {
      ...
      actionsBatch: {
        ...
        Create_Annotations_From_Predictions:
      ...
      helps: {
        Task_ID: "Task ID",
        Task_ID_info:
          "Internal task ID starting from 1 for the current project",
        ...
        Annotation_results_stacked_over:
          "Annotation results stacked over all annotations",
        Annotation_IDs_stacked_over:
          "Annotation IDs stacked over all annotations",
        Average_prediction_score_over_all:
          "Average prediction score over all task predictions",
        Model_versions_aggregated_over:
          "Model versions aggregated over all predictions",
        Prediction_results_stacked_over:
          "Prediction results stacked over all predictions",
        ...
        Average_lead_time_over:
          "Average lead time over all annotations (seconds)",
    ...
    create_project: {
      ...
      config_label: {
        ...
        Automatic_Speech_Recognition_using_Segments:
        ...
        "Coreference_Resolution_&_Entity_Linking":
          "Coreference Resolution & Entity Linking",
        Intent_Classification_and_Slot_Filling:
        ...
        "Supervised_Language_Model_Fine-tuning":
    ...
    labeling: {
      ...
      increase_or_de_playback_amplitude:
  ...
  libs: {
    datamanager: {
      ...
      labelingSettings: {
        ...
        automatically_selects_newly_created_regions:
        ...
        persists_the_selected_tool_across_tasks:
        ...
        smooth_image_pixels_when_zoomed_in:
        ...
        invert_the_direction_of_scroll_to_zoom:
    ...
    hotkeys: {
      ...
      select_next_region_in_current_phrase:
        "Select next region in current phrase",
      select_previous_region_in_current_phrase:
        "Select previous region in current phrase",
      select_all_and_annotate_current_phrase:
        "Select all and annotate current phrase",
    },
  },
};
