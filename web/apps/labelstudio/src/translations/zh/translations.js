  ...
  pages: {
    ...
    create_project: {
      ...
      config_label: {
        ...
        Medical_Image_Classification_with_Bounding_Boxes:
          "带边界框的医学图像分类",
        ...
        Human_Preference_collection_for_RLHF:
          "用于人类反馈强化学习（RLHF）的人类偏好收集",
        LLM_Ranker: "大语言模型排序器",
  ...
  libs: {
    datamanager: {
      ...
      labelingSettings: {
        ...
        enables_quick_selection_of_labels_using_hotkeys:
          "允许使用快捷键快速选择标签",
        enable_labeling_hotkeys: "启用标注快捷键",
        show_hotkeys_on_tooltips: "在工具提示中显示快捷键",
        displays_keybindings_on_tools_and_actions_tooltips:
          "在工具和操作的提示中显示键位绑定",
        ...
        keep_label_selected_after_creating_a_region:
          "创建区域后保持标签选中状态",
        allows_continuous_region_creation_using_the_selected_label:
          "允许使用选定的标签连续创建区域",
        ...
        identify_and_reference_specific_lines_of_text_in_your_document:
          "识别并引用文档中的特定文本行",
