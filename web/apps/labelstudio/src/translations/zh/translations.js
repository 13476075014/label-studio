export const TRANSLATIONS_ZH = {
  ...
  pages: {
    ...
    account_settings: {
      ...
      hot_keys: "热键",
      first_name: "姓",
      error_update_avatar: "更新头像错误",
      error_update_user: "更新用户错误",
      last_name: "名",
      email: "邮箱",
      phone: "手机",
      upload_image: "上传图片",
    ...
    create_project: {
      ...
      config_label: {
        ...
        "Automatic_Speech_Recognition": "自动语音识别",
        "Automatic_Speech_Recognition_using_Segments": "基于分段的自动语音识别",
        "Conversational_Analysis": "对话分析",
        "Intent_Classification": "意图分类",
        "Signal_Quality_Detection": "信号质量检测",
        "Sound_Event_Detection": "声音事件检测",
        "Speaker_Segmentation": "说话人分割",
        "Speech_Transcription": "语音转录",
        "Image_Captioning": "图像描述",
        "Image_Classification": "图像分类",
        "Inventory_Tracking": "库存跟踪",
        "Keypoint_Labeling": "关键点标注",
        "Medical_Image_Classification_with_Bounding_Boxes": "带边界框的医学图像分类",
        "Multi-page_document_annotation": "多页文档标注",
        "Object_Detection_with_Bounding_Boxes": "带边界框的目标检测",
        "Optical_Character_Recognition": "光学字符识别",
        "Semantic_Segmentation_with_Masks": "基于掩码的语义分割",
        "Semantic_Segmentation_with_Polygons": "基于多边形的语义分割",
        "Visual_Genome": "视觉基因组",
        "Visual_Question_Answering": "视觉问答",
        "Coreference_Resolution_&_Entity_Linking": "共指消解与实体链接",
        "Intent_Classification_and_Slot_Filling": "意图分类与槽位填充",
        "Response_Generation": "回复生成",
        "Response_Selection": "回复选择",
        "Chatbot_Model_Assessment": "聊天机器人模型评估",
        "Human_Preference_collection_for_RLHF": "用于人类反馈强化学习（RLHF）的人类偏好收集",
        "LLM_Ranker": "大语言模型排序器",
        "LLM_Response_Grading": "大语言模型响应评分",
        "Supervised_Language_Model_Fine-tuning": "监督式语言模型微调",
        "Visual_Ranker": "视觉排序器",
        ...
        "ASR_Hypotheses_Selection": "自动语音识别假设选择",
        "Content-based_Image_Retrieval": "基于内容的图像检索",
        "Document_Retrieval": "文档检索",
        "Pairwise_classification": "成对分类",
        "Pairwise_regression": "成对回归",
        "Search_Page_Ranking": "搜索页面排名",
        "Text-to-Image_Generation": "文本到图像生成",
        "Freeform_Metadata": "自由格式元数据",
        "HTML_Entity_Recognition": "HTML实体识别",
        "PDF_Classification": "PDF分类",
        "Tabular_Data": "表格数据",
        "Activity_Recognition": "活动识别",
        "Change_Point_Detection": "变化点检测",
        "Outliers_&_Anomaly_Detection": "离群点与异常检测",
        "Signal_Quality": "信号质量",
    ...
    labeling: {
      ...
      Was_skipped: "跳过",
      save_res_key: "保存结果: [ Ctrl+Enter ]",
      no_changes_were_made: "没有任何更改",
      update_this_task_key: "更新当前任务: [ Ctrl+Enter ]",
      View_annotation_activity: "查看注释活动",
      See_a_this_annotation: "查看此注释的用户操作日志",
      Show_more: "展示更多",
      Show_less: "折叠",
  ...
  libs: {
    datamanager: {
      ...
      labelingSettings: {
        ...
        "enables_quick_selection_of_labels_using_hotkeys": "允许使用快捷键快速选择标签",
        "enable_labeling_hotkeys": "启用标注快捷键",
        "show_hotkeys_on_tooltips": "在工具提示中显示快捷键",
        "displays_keybindings_on_tools_and_actions_tooltips": "在工具和操作的提示中显示键位绑定",
        "show_hotkey_tooltips": "显示快捷键提示",
        "show_hotkeys_on_labels": "在标签上显示快捷键",
        "displays_keybindings_on_labels": "在标签上显示键位绑定",
        "show_labels_hotkey_tooltips": "显示标签快捷键提示",
        "show_region_labels": "显示区域标签",
        "display_region_label_names": "显示区域标签名称",
        "show_labels_inside_the_regions": "在区域内显示标签",
        "keep_label_selected_after_creating_a_region": "创建区域后保持标签选中状态",
        "allows_continuous_region_creation_using_the_selected_label": "允许使用选定的标签连续创建区域",
        "select_region_after_creating_it": "创建区域后自动选中",
        "automatically_selects_newly_created_regions": "自动选择新创建的区域",
        "select_regions_after_creating": "创建后选择区域",
        "show_line_numbers": "显示行号",
        "identify_and_reference_specific_lines_of_text_in_your_document": "识别并引用文档中的特定文本行",
        "show_line_numbers_for_text": "为文本显示行号",
        "keep_selected_tool": "保持选中的工具",
        "persists_the_selected_tool_across_tasks": "在不同任务间保持选中的工具",
        "remember_selected_tool": "记住选中的工具",
        "pixel_smoothing_on_zoom": "缩放时进行像素平滑",
        "smooth_image_pixels_when_zoomed_in": "放大时平滑图像像素",
        "enable_image_smoothing_when_zoom": "启用缩放时的图像平滑",
        "invert_zoom_direction": "反转缩放方向",
        "invert_the_direction_of_scroll_to_zoom": "反转滚动缩放的方向",
        "enable_inverted_zoom_direction": "启用反转缩放方向",
        Labeling_Interface_Settings: "标签界面设置"
      }
    },
    edit: {
    ...
    "hotkeys": {
      "back_for_one_second": "后退一秒",
      "play_pause": "播放/暂停",
      "go_one_step_back": "后退一步",
      "go_one_step_forward": "前进一步",
      "increase_region_to_the_left": "向左增加区域",
      "increase_region_to_the_right": "向右增加区域",
      "decrease_region_on_the_left": "向左缩小区域",
      "decrease_region_on_the_right": "向右缩小区域",
      "submit_annotation": "提交标注",
      "skip_task": "跳过任务",
      "undo": "撤销",
      "redo": "重做",
      "delete_all_regions": "删除所有区域",
      "focus_first_focusable_region": "聚焦第一个可聚焦的区域",
      "create_relation_between_regions": "在区域之间创建关系",
      "toggle_selected_region_visibility": "切换选中区域的可见性",
      "toggle_all_regions_visibility": "切换所有区域的可见性",
      "lock_selected_region": "锁定选中区域",
      "edit_selected_region_meta": "编辑选中区域的元数据",
      "unselect_region": "取消选择区域",
      "exit_relation_mode_unselect_region": "退出关系模式，取消选择区域",
      "delete_selected_region": "删除选中区域",
      "cycle_through_regions": "循环切换区域",
      "duplicate_selected_region": "复制选中区域",
      "go_to_previous_keyframe": "转到上一个关键帧",
      "go_to_next_keyframe": "转到下一个关键帧",
      "go_back": "后退",
      "go_to_first_frame": "转到第一帧",
      "go_forward": "前进",
      "go_to_last_frame": "转到最后一帧",
      "hop_backward": "向后跳跃",
      "hop_forward": "向前跳跃",
      "next_page": "下一页",
      "previous_page": "上一页",
      "previous_image": "上一张图片",
      "next_image": "下一张图片",
      "zoom_in_on_the_image": "放大图像",
      "pan_around_the_image": "平移图像",
      "zoom_to_fit_the_full_image_in_view": "缩放以适应视图中的完整图像",
      "zoom_to_actual_image_size_100_": "缩放到实际图像大小 (100%)",
      "zoom_out_of_the_image": "缩小图像",
      "select_the_ellipse_tool": "选择椭圆工具",
      "select_the_eraser_tool": "选择橡皮擦工具",
      "use_the_auto_detect_tool_to_automatically_suggest_regions": "使用自动检测工具自动建议区域",
      "draw_a_rotated_rectangle_using_3_point_selection": "使用3点选择绘制旋转矩形",
      "select_the_key_point_annotation_tool": "选择关键点标注工具",
      "select_the_magic_wand_tool_for_smart_region_selection": "选择魔棒工具进行智能区域选择",
      "select_the_polygon_annotation_tool": "选择多边形标注工具",
      "select_the_rectangle_annotation_tool": "选择矩形标注工具",
      "rotate_the_image_90_to_the_left": "将图像向左旋转90°",
      "rotate_the_image_90_to_the_right": "将图像向右旋转90°",
      "select_the_move_tool_to_reposition_annotations": "选择移动工具以重新定位标注",
      "select_the_brush_tool": "选择画笔工具",
      "decrease_tool_size": "减小工具尺寸",
      "increase_tool_size": "增大工具尺寸",
      "move_to_next_phrase": "移动到下一个短语",
      "move_to_previous_phrase": "移动到上一个短语",
      "select_next_region_in_current_phrase": "在当前短语中选择下一个区域",
      "select_previous_region_in_current_phrase": "在当前短语中选择上一个区域",
      "select_all_and_annotate_current_phrase": "选择全部并标注当前短语"
    }
  },
};
