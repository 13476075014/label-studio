...
export const DEFAULT_HOTKEYS = [
  ...
  },
  {
    ...
    label: defaultT(t, "pages.account_settings.video.last_frame", "Last Frame"),
  ...
  },
  {
    ...
    section: "tools",
    element: "tool:brush",
    label: defaultT(t, "pages.account_settings.tools.brush_tool", "Brush Tool"),
    key: "B",
    description: defaultT(
      t,
  ...
  },
  {
    ...
    label: defaultT(t, "pages.account_settings.tools.magic_wand", "Magic Wand"),
    key: "W",
    description: defaultT(
      t,
...
export const HOTKEY_SECTIONS = [
  ...
  {
    id: "data_manager",
    title: defaultT(t, "pages.account_settings.data_manager", "Data Manager"),
    description: defaultT(
      t,
  ...
  {
    id: "tools",
    title: defaultT(t, "pages.account_settings.tools", "Tools"),
    description: defaultT(
      t,
